...
const PersonalProductivityPage = () => {
  let database = "Personal Productivity"
  ...
  if (isMobile){
    return (
      <div className='flex flex-col items-center w-full my-6'>
        ...
        {selectedValue === 'Overview' && <Overview name={database} type="Number" prefix="" suffix=""/>}
  ...
  return (
    <Tabs className='w-full' defaultValue='overview'>
      ...
      <TabsContent value='Overview'>
        <Overview name={database} type="Number" prefix="" suffix=""/>
      </TabsContent>
