...
import NotionTables from '../_components/NotionTables'
...
const PersonalFinancePage = () => {
  let database = "Personal Finance"
  let notionTemplateUrl = "https://anoopkarnik.notion.site/Personal-Finance-System-1021d3faa0a08020a584c91adedea576?pvs=74"
  ...
  if (isMobile){
    return (
      <div className='flex flex-col items-center w-full my-6'>
        ...
        {selectedValue === 'Overview' && <Overview name={database} type="Currency" prefix="Rs " suffix=""/>}
  ...
  return (
    <Tabs className='w-full' defaultValue='overview'>
      ...
      <TabsContent value='Overview'>
        <Overview name={database} type="Currency" prefix="Rs " suffix=""/>
      </TabsContent>
